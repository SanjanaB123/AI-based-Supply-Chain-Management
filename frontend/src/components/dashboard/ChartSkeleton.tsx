export default function ChartSkeleton() {
  return (
    <div className="animate-pulse rounded-xl border border-slate-100 bg-white shadow-sm">
      <div className="flex flex-col gap-6 p-5">

        {/* Donut placeholder */}
        <div className="mx-auto h-44 w-44 shrink-0 rounded-full bg-slate-100" />
          ...
          {[0, 1, 2].map(i => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="mt-1 h-2 w-2 rounded-full bg-slate-100" />
              ...
              <div className="flex gap-3 pl-4">
                <div className="h-3 w-5 rounded-full bg-slate-100" />
